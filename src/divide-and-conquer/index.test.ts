...
describe('Divide and Conquer', () => {
    ...
    describe('Binary Search', () => {
        ...
        it('iterativeBinarySearch Returns expeected results from unsorted array', () => {
            // JSON.parse(JSON.stringify(...)) is used to create a deep copy of the array
            const reversedSortedArray = JSON.parse(
        ...
        it('recursiveBinarySearch Returns expected results from unsorted arry with correct params', () => {
            ...
            expect(
                recursiveBinarySearch(reversedSortedArray, low, high, 4)
            ).toBe(3)
            expect(
                recursiveBinarySearch(reversedSortedArray, low, high, 6)
            ).toBe(5)
            expect(
                recursiveBinarySearch(reversedSortedArray, low, high, 11)
            ).toBe(-1)
        })
